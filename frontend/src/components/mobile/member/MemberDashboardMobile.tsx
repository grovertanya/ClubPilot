      ...
      >
        ...
        <motion.div variants={itemVariants}>
          <div className="flex items-center justify-between mb-3">
            ...
            <button className="text-sm text-[#429ebd]">All</button>
          </div>
          
          <Card className="bg-[#1e293b] border-[#334155] p-4 mb-3">
            <div className="flex items-start justify-between mb-3">
              <div>
                <h3 className="text-[#e2e8f0] mb-1">Debate Club</h3>
                <p className="text-sm text-[#94a3b8]">Tuesday, 6:00 PM</p>
              </div>
            ...
            <div className="flex items-center justify-between text-sm">
              <span className="text-[#64748b]">18/20 attending</span>
              <Button
                size="sm"
                variant="outline"
                className="border-[#429ebd] text-[#429ebd]"
              >
                View Event
              </Button>
            </div>
          ...
          <Card className="bg-[#1e293b] border-[#334155] p-4">
            <div className="flex items-start justify-between mb-3">
              <div>
                <h3 className="text-[#e2e8f0] mb-1">Public Speaking Workshop</h3>
                <p className="text-sm text-[#94a3b8]">Friday, 5:00 PM</p>
              </div>
              <Badge variant="secondary" className="bg-[#eab308]/20 text-[#eab308]">
                Interested
              </Badge>
            </div>
            <div className="flex items-center justify-between text-sm">
              <span className="text-[#64748b]">8/20 attending</span>
              <Button
                size="sm"
                variant="outline"
                className="border-[#429ebd] text-[#429ebd]"
        ...
        <motion.div variants={itemVariants}>
          <Card className="bg-gradient-to-br from-[#429ebd]/20 to-[#9fe7f5]/10 border-[#429ebd]/30 p-4">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                <h3 className="text-[#e2e8f0]">You're a reliable member!</h3>
                <p className="text-sm text-[#94a3b8]">14/16 events attended</p>
              </div>
            </div>
            <div className="text-center">
              <div className="text-4xl text-white mb-1">87%</div>
              <p className="text-sm text-[#94a3b8]">Attendance Rate</p>
            </div>
          </Card>
        </motion.div>
      </motion.div>
